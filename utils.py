...
def summarize_article(content, max_length=50, max_input_length=1024):
    ...
    Args:
        ...
        max_length (int): Maximum length of the summary (in words or tokens).
        max_input_length (int): Maximum length of each input chunk (in tokens).
    
    Returns:
        str: A single-line summary of the article.
    """
    ...
    for chunk in chunks:
        try:
            ...
            # Handle errors (e.g., if the chunk is too short)
